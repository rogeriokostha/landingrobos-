...
export default function LandingPage() {
  ...
  <div className="container mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
    <div className="flex items-center space-x-3">
      ...
      <div className="min-w-0">
        <div className="text-xl font-black tracking-tight leading-tight">FÁBRICA DE ROBÔS</div>
        <div className="text-xs text-yellow-400 font-medium whitespace-normal break-words leading-tight">
          FOOD TECH REVOLUTION
        </div>
      </div>
    </div>

    <Button className="w-full sm:w-auto bg-gradient-to-r from-yellow-400 to-yellow-500 text-black hover:from-yellow-500 hover:to-yellow-600 font-bold px-6">
      COMEÇAR AGORA
    </Button>
  </div>
</header>
      ...
      {/* Hero Section */}
      <section className="pt-16 sm:pt-12 relative min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
        {/* Background Grid */}
  ...
  <Badge className="bg-yellow-400 text-black border-yellow-500 shadow-md px-4 sm:px-6 py-2 text-sm font-bold tracking-wide uppercase whitespace-normal break-words text-center leading-tight">
    <div className="inline-flex items-center justify-center gap-2">
      <Sparkles className="w-4 h-4 inline-block flex-shrink-0" />
      <span className="break-words">A ERA DOS ROBÔS CHEGOU AO FOOD BUSINESS</span>
    </div>
  </Badge>
</div>
      ...
      <section className="py-32 bg-gradient-to-r from-yellow-500 via-yellow-400 to-blue-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <Button
  size="lg"
  className="w-full sm:w-auto bg-black text-yellow-400 hover:bg-gray-900 text-xl sm:text-2xl px-6 sm:px-12 py-6 font-black rounded-2xl transform hover:scale-105 transition-all duration-300 shadow-2xl mb-8"
>
  <div className="inline-flex items-center justify-center gap-3 flex-nowrap min-w-0">
    <Rocket className="h-6 w-6 flex-shrink-0" />
    <span className="break-words text-center">QUERO MEUS ROBÔS AGORA</span>
  </div>
</Button>
